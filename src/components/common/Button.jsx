/**
 * Button.jsx
 * Botón reutilizable - con efectos hover elegances.
 */
...
const Button = ({ variant = 'primary', href, size = 'md', children, onClick, type = 'button' }) => {
  ...
  const variants = {
    ...
    outlineGold: 'bg-transparent border-2 border-gold-500 text-gold-500 hover:bg-gold-500 hover:text-primary-900',
